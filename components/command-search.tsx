...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    // Platform
    { title: "Team", url: "/dashboard", group: "Platform", icon: Users },
    { title: "General Settings", url: "/dashboard/general", group: "Platform", icon: Settings },
    { title: "Security Settings", url: "/dashboard/security", group: "Platform", icon: Shield },
    { title: "Activity Log", url: "/dashboard/activity", group: "Platform", icon: Activity },

    // Authentication
    { title: "Sign In", url: "/sign-in", group: "Authentication", icon: LogIn },
    { title: "Sign Up", url: "/sign-up", group: "Authentication", icon: UserPlus },

    // Pages
    { title: "Pricing", url: "/pricing", group: "Pages", icon: CreditCard },
    { title: "Blocks", url: "/blocks", group: "Pages", icon: Box },
    { title: "Landing Page", url: "/landing", group: "Pages", icon: Globe },
  ]
